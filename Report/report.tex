...
\begin{figure}[H]
	\centering
	\includegraphics[width=.85\textwidth]{../out/bayes/sample-pdf-plot-A.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.85\textwidth]{../out/bayes/misclass-pdf-plot-A.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.85\textwidth]{../out/bayes/sample-pdf-plot-B.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.85\textwidth]{../out/bayes/misclass-pdf-plot-B.png}
